...
python3 v3/host/qualification_runner.py \
  --state .qualification/alpha28.state.json \
  --evidence .qualification/alpha28.evidence.json \
  --device-id iot-md-001 --version 3.0.0-alpha.28 --sequence 2733 status
```
...
python3 v3/host/qualification_runner.py \
  --state .qualification/alpha28.state.json \
  --evidence .qualification/alpha28.evidence.json \
  --device-id iot-md-001 --version 3.0.0-alpha.28 --sequence 2733 monitor \
