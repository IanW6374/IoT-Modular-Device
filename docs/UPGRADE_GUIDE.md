...
python3 v3/host/qualification_runner.py \
  --state .qualification/alpha31.state.json \
  --evidence .qualification/alpha31.evidence.json \
  --device-id iot-md-001 --version 3.0.0-alpha.31 --sequence 2736 status
```
...
python3 v3/host/qualification_runner.py \
  --state .qualification/alpha31.state.json \
  --evidence .qualification/alpha31.evidence.json \
  --device-id iot-md-001 --version 3.0.0-alpha.31 --sequence 2736 monitor \
