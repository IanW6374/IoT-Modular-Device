...
python3 v3/host/qualification_runner.py \
  --state .qualification/alpha24.state.json \
  --evidence .qualification/alpha24.evidence.json \
  --device-id iot-md-001 --version 3.0.0-alpha.24 --sequence 2729 status
```
...
python3 v3/host/qualification_runner.py \
  --state .qualification/alpha24.state.json \
  --evidence .qualification/alpha24.evidence.json \
  --device-id iot-md-001 --version 3.0.0-alpha.24 --sequence 2729 monitor \
