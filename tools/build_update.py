...
CORE_FILES = (
    ...
    'services/qualification_control_service.py',
    'services/configuration_profile_service.py',
...
PORTAL_ROUTE_SPLITS = (
    ...
    (
        ...
        (
            ...
            'resumable_complete', 'resumable_discard', 'resumable_status', 'route',
    ...
    (
        ...
        (
            ...
            'task_list_getter', 'task_status_getter', 'upload_progress_by_id',
