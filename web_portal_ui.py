...
PORTAL_CSS = (
    ...
    'gap:20px;align-items:stretch}.upgrade-steps-panel{border-bottom:1px solid var(--line);'
    'padding:0 0 20px;min-width:0}'
    ...
    '.upgrade-overall{margin:18px 0 10px;padding:0}.upgrade-overall[hidden]{display:none}'
    '.upgrade-overall-head{display:flex;justify-content:flex-start;gap:13px;align-items:baseline}'
    '.upgrade-overall-head span{color:inherit;font-size:inherit;font-variant-numeric:tabular-nums}'
    ...
    'flex:1 1 0;grid-template-rows:4.25rem 3.25rem;justify-items:center;align-items:end;min-width:0;'
    'color:var(--muted);text-align:center}.upgrade-stage-list li:not(:last-child):after{content:"";position:absolute;'
    'z-index:0;left:50%;right:-50%;bottom:1.55rem;height:3px;background:var(--line)}'
    ...
    '.upgrade-method-choices{display:grid;grid-template-columns:repeat(auto-fit,minmax(15rem,1fr));gap:12px;'
    ...
    '.upgrade-method-choice:hover,.upgrade-method-choice:focus-visible{border-color:var(--accent);outline:2px solid var(--accent);'
    'outline-offset:2px}.upgrade-method-choice strong{color:var(--accent)}.upgrade-method-choice small{'
