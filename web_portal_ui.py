...
PORTAL_CSS = (
    ...
    'gap:16px;margin:20px 0}.qualification-action{padding:18px;border:1px solid var(--line);'
    'border-radius:14px;background:var(--soft)}.qualification-action h3{margin-bottom:5px}'
