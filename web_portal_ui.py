...
PORTAL_CSS = (
    ...
    'flex:1;flex-direction:column;min-height:100%}.upgrade-operation .actions{margin-top:auto;padding-top:14px}'
    ...
    '.upgrade-stage-list{display:grid;grid-template-columns:repeat(var(--upgrade-step-count),minmax(7rem,1fr));'
    ...
    'grid-template-rows:4.25rem 3.25rem;justify-items:center;align-items:end;min-width:0;'
    ...
    'padding:0 5px 8px;line-height:1.2}.upgrade-stage-ring{position:relative;z-index:1;display:grid;'
    ...
    '.upgrade-stage-list li.complete{--step-colour:var(--good);color:var(--good)}'
    ...
    'margin:10px 0}.upgrade-method-choice{display:grid;gap:5px;align-content:start;min-height:7rem;padding:16px;'
    ...
    'opacity:.55;pointer-events:none}.change-upgrade-method{margin-right:auto}'
    ...
    '.upgrade-stage-list{grid-template-columns:1fr;min-width:0;gap:0}.upgrade-stage-list li{'
