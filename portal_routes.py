...
ROUTES = {
    ...
    '/task': ('viewer', 'operations'),
    '/update-task': ('operator', 'operations'),
    '/api/tasks': ('viewer', 'operations'),
    ...
    '/resumable-upload-discard': ('operator', 'updates'),
    ...
    '/record-qualification-event': ('administrator', 'maintenance'),
    '/run-qualification-scenario': ('administrator', 'maintenance'),
    ...
    '/update-api-client-scopes': ('administrator', 'system'),
